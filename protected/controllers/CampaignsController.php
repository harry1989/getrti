...
class CampaignsController extends Controller
{
	...
	public function actionView ($id)
	{
		...
		$positionsProvider= new CActiveDataProvider('Positions');
	        if($positionsProvider===null)
			Yii::log('Testa Rosa 1', CLogger::LEVEL_WARNING, 'system.*');				
	        if($campaign===null)
		{
			$this->render('invalidCampaign');
			Yii::app()->end();			
		}
		$newPosition = new Positions;
	  	$this->render('view',array('campaign'=>$campaign,'positionsProvider'=>$positionsProvider,'newPosition'=>$newPosition,'issue_id'=>$id));
	}
